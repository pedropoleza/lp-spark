...
export const PLAN_CONTENT: PlanContent[] = [
  {
    ...
    accent: "electric",
    features: [
      "CRM completo com pipeline de vendas pronto",
      "Templates bilíngues PT/EN",
    ...
    badges: ["Para começar", "CRM + Follow-up", "Sem SparkBot"],
  },
  {
    id: "growth",
    name: "Growth",
    ...
    features: [
      ...
      "SparkBot na sua operação (IA que responde e agenda)",
      "Lead Engagement Score",
      "Revisão anual e retenção automatizadas",
    ...
    badges: ["SparkBot incluso", "Lead Score", "Recrutamento"],
  },
  {
    id: "agency",
    name: "Agency",
    ...
    features: [
      "Tudo do Growth, mais:",
      "SparkBot multi-user (1 por agente)",
      "Pipeline de recrutamento completo",
      "Templates e workflows de equipe",
      "Field Training organizado",
      "Calendários extras para o time",
      "Agency Dashboard com KPIs da equipe",
      "Onboarding personalizado + Suporte 24/7",
    ],
    ...
    badges: ["Para líderes", "Equipe completa", "SparkBot multi-user"],
  },
];

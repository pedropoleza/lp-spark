/**
 * Notas do apresentador da palestra de Organização/CRM (a "cola").
 * Aparecem só no modo Zoom, com a tecla N. Chave = id da cena.
 */
export const ORG_NOTES: Record<string, string[]> = {
  capa: [
  ...
  calculadora: [
    "ESTE é o auge. Use os números reais da sala",
    "Pergunte: horas/semana caçando informação? Quanto vale sua hora?",
    "Deixe o número de HORAS/ano subir e fique em silêncio",
  ],
  "ficar-atras": [
    "Aversão à perda: não é deixar de ganhar, é estar PERDENDO agora",
    "Curva de adoção (Rogers): ninguém quer ser o último 16% a mudar",
    "Dado sólido na tela: <30% do tempo é vendendo (Salesforce). Outro real: ~1 em 4 leads nunca recebe resposta (HBR 2011)",
    "NÃO cite “91% usam CRM” nem “$8,71 de ROI”: são fracos/marketing",
  ],
  crm: [
  ...
  "planilha-quebra": [
    ...
    "Prova social: a agência DELES já usa o Spark",
    "Quando cresce, organização tem que virar sistema",
  ],
  spark: [
    "Mostre, não conte: abra a base organizada e a Automação",
    "“Olha a sua base viva, cada cliente com histórico”",
    "Passe por Conversas / SparkBot se engajar",
  ],
  motivos: [
    "3 motivos sobre EFICIÊNCIA/organização, a nível do agente",
    "Amarre ao “virar empresa, não gargalo”",
  ],
  oferta: [
  ...
  fechamento: [
    ...
    "QR = AGENDAR DEMO (defina ?cta= com seu link de agenda)",

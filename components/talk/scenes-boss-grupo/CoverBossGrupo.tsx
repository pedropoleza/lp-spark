...
import { COVER_GRUPO } from "@/content/talk/copy-boss-grupo";

export function CoverBossGrupo() {
  return (
    <TalkSceneFrame hint="Setas ← → para navegar · F tela cheia · N seu roteiro">
      ...
      <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="label-mono text-center">
        {COVER_GRUPO.eyebrow} <BossMark className="text-accent" />
      </motion.p>
      ...
      >
        As vendas que <span className="gradient-text">você já tem</span>.
      </motion.h1>

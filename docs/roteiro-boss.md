...
- "Natália, obrigado pelo tempo. Vou ser direto e te mostrar coisa de valor."
- "Montei essa conversa pensando na BO$$, não é uma demo genérica."
- "Em uns 20 minutos você vê uma estrutura desenhada pra uma agência do seu tamanho."
- [tela: BO$$ × Spark]
...
## 5. O produto funcionando
- "Deixa eu te mostrar funcionando, rapidinho."
- "Esse é o funil. Olha o selo: sincronizado com a Five Rings."
- "Aqui as conversas, todos os canais numa caixa só."
...
- "Você não vai só usar um CRM. Vai desenhar a estrutura que seus agentes rodam."
- "Você entende o sistema uma vez, e vira a arquiteta da operação da BO$$."

## 8. Snapshots por plano (o ápice)
- "Isso a gente chama de snapshot. Pensa assim:"
- "Você customiza o Starter com a cara da BO$$. O Growth com a cara da BO$$. O Agency com a cara da BO$$."
- "Cada um vira um pacote pronto que você replica pra cada agente, com um clique."
- "Customiza uma vez, entrega pra todo mundo. Numa agência do seu tamanho, isso é escala de verdade."
- [tela: 3 cards white-label Starter / Growth / Agency]

## 9. Integração Five Rings (o diferencial)
- "E o diferencial que ninguém te dá: a gente integra com o portal da Five Rings."
- "Importa os dados e roda automações de controle de agência em cima disso."
- "Já temos um modelo pronto, mas tudo é personalizável pra forma como a BO$$ trabalha."
- [tela: portal Five Rings > automações]

## 10. Segurança & independência
- "Sobre segurança, que numa agência grande é inegociável:"
- "Os dados são seus, criptografados, e você exporta quando quiser. Suporte humano em português."
- "E um ponto importante: a gente é uma operação independente, prestadora de serviço pra Five Rings."
- "Não somos agentes e não temos vínculo com nenhum agente. Justamente pra não ter conflito de interesse."
- [tela: segurança clara, bem disposta]

## 11. A estrutura da BO$$
- "Juntando tudo: paridade com o que você já usa, migração sem perda, snapshots pros agentes, integração Five Rings e segurança."
- "Isso não é trocar de CRM. É montar a estrutura da BO$$."
